...
public class CeruleanCity {
    public CeruleanCity(Player player) throws SQLException {
        player.location="Cerulean City";
        System.out.println("\n\n\n+----------------------------------------------------------------------+\n" +
                "You are currently in Cerulean City:\n" +
                "+----------------------------------------------------------------------+\n" +
                "[1] Move to:\n" +
                "a.Pewter City   b.Saffron City   c.Lavender Town\n" +
                "[2] Challenge Gym leader [Misty-Water Type]\n" +
                "[3] Fight Wild Pokemon [Squirtle, Lapras, Glalie]\n" +
                "[4] Player Options\n" +
        ...
        if(choice.equals("1a")){
            ...
            System.out.println("You are about to challenge Gym Leader Misty!");
            ...
            System.out.println("+----------------------------------------------------------------------+");
            Pokemon enemy=createLeaderPokemon("Grass",12);
            ...
            if(myPokemonCurrentHealth<=0)
                ...
                new BadgeFrame("Cascade", "cascade");
                player.Badges.add("Cascade Badge");
            ...
            Pokemon enemy;
            if(Number==1){
                enemy=createPokemon("Squirtle", myPokemon.level-1);
            }else if(Number==2){
                enemy=createPokemon("Lapras", myPokemon.level-1);
            }else{
                enemy=createPokemon("Glalie", myPokemon.level-1);
            }

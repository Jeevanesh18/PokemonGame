...
public class PalletTown {
    public PalletTown(Player player) throws SQLException {
        ...
        System.out.println("\n\n\n+----------------------------------------------------------------------+\n" +
                ...
                "[3] Fight Wild Pokemon [Pidgey, Meowth, Sycther]\n" +
                "[4] Player Options\n" +
        ...
        if(choice.equals("1a")){
            ...
            Pokemon enemy;
            if(Number==1){
                enemy=new Pokemon("Meowth","Normal", myPokemon.level-1,0);
                enemy.move1Name="Scratch";
                enemy.move1Damage=33+(enemy.level-1)*2;
                enemy.move2Name="Growl";
                enemy.move2Damage=2+(enemy.level-1)*2;
                enemy.strength.add("Normal");
                enemy.weakness.add("Fighting");
                enemy.weakness.add("Bug");
                enemy.weakness.add("Rock");
            }else if(Number==2){
                enemy=new Pokemon("Pidgey","Normal", myPokemon.level-1,0);
                enemy.move1Name="Gust";
                enemy.move1Damage=4+(enemy.level-1)*2;
                enemy.move2Name="Quick Attack";
                enemy.move2Damage=31+(enemy.level-1)*2;
                enemy.strength.add("Flying");
                enemy.strength.add("Normal");
                enemy.weakness.add("Electric");
                enemy.weakness.add("Ice");
                enemy.weakness.add("Rock");
            }else{
                enemy=new Pokemon("Scyther","Bug", myPokemon.level-1,0);
                enemy.move1Name="Wing Attack";
                enemy.move1Damage=28+(enemy.level-1)*2;
                enemy.move2Name="Quick Attack";
                enemy.move2Damage=22+(enemy.level-1)*2;
                enemy.strength.add("Flying");
                enemy.strength.add("Bug");
                enemy.weakness.add("Electric");
                enemy.weakness.add("Ice");
                enemy.weakness.add("Fire");
            }
    ...
    public static void saveexit(Player player) throws SQLException {
        ...
        "WHERE NOT EXISTS ("+
                "SELECT 1 FROM players WHERE Player_Name = '"+player.name+"' AND Badges = '"+x+"');";

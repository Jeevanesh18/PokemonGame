...
public class PewterCity {
    public PewterCity(Player player) throws SQLException {
        player.location="Pewter City";
        System.out.println("\n\n\n+----------------------------------------------------------------------+\n" +
                "You are currently in Pewter City:\n" +
                "+----------------------------------------------------------------------+\n" +
                "[1] Move to:\n" +
                "a.Viridian City   b.Cerulean City\n" +
                "[2] Challenge Gym leader [Brock-Rock Type]\n" +
                "[3] Fight Wild Pokemon [Geodude, Nosepass, Sudowoodo]\n" +
                "[4] Player Options\n" +
        ...
        if(choice.equals("1a")){
            ...
            System.out.println("You are about to challenge Gym Leader Brock!");
            ...
            System.out.println("+----------------------------------------------------------------------+");
            Pokemon enemy=createLeaderPokemon("Rock",12);
            ...
            if(myPokemonCurrentHealth<=0)
                ...
                new BadgeFrame("Boulder", "boulder");
            ...
            Pokemon enemy;
            if(Number==1){
                enemy=createPokemon("Geodude", myPokemon.level-1);
            }else if(Number==2){
                enemy=createPokemon("Nosepass", myPokemon.level-1);
            }else{
                enemy=createPokemon("Sudowoodo", myPokemon.level-1);
            }

...
public class VermillionCity {
    public VermillionCity(Player player) throws SQLException {
        player.location="Vermillion City";
        System.out.println("\n\n\n+----------------------------------------------------------------------+\n" +
                "You are currently in Vermillion City:\n" +
                "+----------------------------------------------------------------------+\n" +
                "[1] Move to:\n" +
                "a.Saffron City   b.Lavender Town\n" +
                "[2] Challenge Gym leader [Lt.Surge-Electric Type]\n" +
                "[3] Fight Wild Pokemon [Pikachu, Raichu, Electabuzz]\n" +
                "[4] Player Options\n" +
        ...
        if(choice.equals("1a")){
            ...
            System.out.println("You are about to challenge Gym Leader Lt.Surge!");
            ...
            System.out.println("+----------------------------------------------------------------------+");
            Pokemon enemy=createLeaderPokemon("Electric",12);
            ...
            if(myPokemonCurrentHealth<=0)
                ...
                new BadgeFrame("Thunder", "thunder");
                player.Badges.add("Thunder Badge");
            ...
            Pokemon enemy;
            if(Number==1){
                enemy=createPokemon("Pikachu", myPokemon.level-1);
            }else if(Number==2){
                enemy=createPokemon("Raichu", myPokemon.level-1);
            }else{
                enemy=createPokemon("Electabuzz", myPokemon.level-1);
            }

...
public class FuchsiaCity {
    public FuchsiaCity(Player player) throws SQLException {
        player.location="Fuchsia City";
        System.out.println("\n\n\n+----------------------------------------------------------------------+\n" +
                "You are currently in Fuchsia City:\n" +
                "+----------------------------------------------------------------------+\n" +
                "[1] Move to:\n" +
                "a.Cinnabar Island   b.Celadon City   c.Vermillion City   d.Lavender Town\n" +
                "[2] Challenge Gym leader [Koga-Poison Type]\n" +
                "[3] Fight Wild Pokemon [Weezing, Muk, Duskull]\n" +
                "[4] Player Options\n" +
        ...
        if(choice.equals("1a")){
            ...
            System.out.println("You are about to challenge Gym Leader Koga!");
            ...
            System.out.println("+----------------------------------------------------------------------+");
            Pokemon enemy=createLeaderPokemon("Poison",12);
            ...
            if(myPokemonCurrentHealth<=0)
                ...
                new BadgeFrame("Soul", "soul");
                player.Badges.add("Soul Badge");
            ...
            Pokemon enemy;
            if(Number==1){
                enemy=createPokemon("Weezing", myPokemon.level-1);
            }else if(Number==2){
                enemy=createPokemon("Muk", myPokemon.level-1);
            }else{
                enemy=createPokemon("Duskull", myPokemon.level-1);
            }

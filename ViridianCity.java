...
public class ViridianCity {
    public ViridianCity(Player player) throws SQLException {
        player.location="Viridian City";
        System.out.println("\n\n\n+----------------------------------------------------------------------+\n" +
                ...
                "[3] Fight Wild Pokemon [Eevee, Rattata, Snorlax]\n" +
                "[4] Player Options\n" +
        ...
        if(choice.equals("1a")){
            ...
            System.out.println("You are about to challenge Gym Leader Giovanni!");
            ...
            System.out.println("+----------------------------------------------------------------------+");
            Pokemon enemy=createLeaderPokemon("Ground",1);
            ...
            Pokemon enemy;
            if(Number==1){
                enemy=createPokemon("Eevee", myPokemon.level-1);
            }else if(Number==2){
                enemy=createPokemon("Rattata", myPokemon.level-1);
            }else{
                enemy=createPokemon("Snorlax", myPokemon.level-1);
            }
